...
import gov from "../../data2/gov_finance.json";

/** Scrape instant of the newest registry pull, as "24 Jul 2026". */
function lastUpdated() {
  return new Date(gov.scrapedAt).toLocaleDateString("en-GB", {
    day: "numeric",
    month: "short",
    year: "numeric",
    timeZone: "UTC",
      ...
      <div className="wrap mx-auto w-full max-w-[840px] px-6 pt-6 pb-[84px]">
        ...
        <header className="relative isolate mt-1.5 mb-[26px]">
          ...
          <p className="text-muted mb-2 text-[11px] font-semibold tracking-[.18em] uppercase">
            Lithuanian restaurants &amp; bars · {model.years[0]}–
