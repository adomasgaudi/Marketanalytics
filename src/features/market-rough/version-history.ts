...
export const VERSIONS: VersionEntry[] = [
  {
    v: "v3.113.0",
    date: "2026-09-10",
    title: "Restore hidden developer tools",
    desc: "Restores the developer panel and loads the xray toolbar only in developer mode, unlocked with eight version clicks.",
  },
  {
    v: "v3.112.0",
    date: "2026-09-10",
  ...
  },
  {
    ...
    desc: "Aligns package metadata, the app label, and release history at v3.111.",
  },
  {
    v: "v3.110.0",
    date: "2026-08-07",
    title: "Responsive scatter labels",
    desc: "Labels both plotted axes with the selected metric and per-employee basis when relevant.",
  },
  {
    v: "v3.109.0",
    date: "2026-08-07",
  ...
  },
  {
    ...
    desc: "Names the company comparison clearly and separates responsive year and segment context.",
  },
  {
    v: "v3.107.0",
    date: "2026-08-07",
  ...
  },
  {
    ...
    desc: "Shows the half-second loading transition before a scoped donut opens a company.",
  },
  {
    v: "v3.105.0",
    date: "2026-08-07",
    title: "Distinct Companies canvas",
    desc: "Adds a restrained page-wide violet treatment so Companies reads as a different destination.",
  },
  {
    v: "v3.104.0",
    date: "2026-08-07",
  ...
  },
  {
    ...
    desc: "Each company now has one canonical main segment (workbook Veikla when set, else first activity). Shown as “main” in the profile; scatter and deduped counts use it so multi-segment brands don’t conflict.",
  },
  {
    v: "v3.53.0",
    date: "2026-07-23",
  ...
  },
  {
    ...
    desc: "Dropped YoY from formula folds. Filed figures (turnover, profit, headcount, salary) now show value + data2 path + scrape source; revenue keeps its build formula.",
  },
  {
    v: "v3.46.0",
    date: "2026-07-23",
  ...
  },
  {
    ...
    desc: "On touch devices, scrolling the year carousel now selects the enabled year nearest its centre when the swipe settles.",
  },
  {
    v: "v3.42.4",
    date: "2026-07-23",
